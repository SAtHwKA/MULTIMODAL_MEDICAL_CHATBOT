...
A multimodal AI-powered chatbot that accepts text, images, and audio as input to provide general health and wellness information through an interactive Gradio interface.
